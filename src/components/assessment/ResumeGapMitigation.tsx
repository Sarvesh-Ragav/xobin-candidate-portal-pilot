...
export default function ResumeGapMitigation() {
        ...
        >
          ...
          <div className="mb-8 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold tracking-tight text-white">
                Resume Gap Mitigation
              </h1>
              <p className="text-sm text-zinc-400">
                Explain your career gap and demonstrate your readiness
              </p>
            </div>
          </div>
          ...
          {step === 1 && (
            ...
            >
              <div>
                ...
                <textarea
                  placeholder="Enter the duration and reason for your career gap..."
          ...
          {step === 2 && (
            ...
            >
              <div>
                <label className="mb-2 block text-xs font-semibold uppercase tracking-wider text-zinc-500">
                  What did you learn or improve during this period?
                </label>
                <textarea
                  placeholder="Skills, certifications, projects, or personal growth..."
                  className="w-full rounded-xl border border-zinc-700/60 bg-zinc-800/50 py-3 px-4 text-sm text-white placeholder-zinc-600 outline-none transition-all focus:border-violet-500/70 focus:ring-2 focus:ring-violet-500/20"
                  rows={4}
                />
              </div>
          ...
          {step === 3 && (
            ...
            >
              <div>
                <label className="mb-2 block text-xs font-semibold uppercase tracking-wider text-zinc-500">
                  How are you prepared to return to work?
                </label>
                <textarea
                  placeholder="Your readiness, motivation, and how you stayed current..."
                  className="w-full rounded-xl border border-zinc-700/60 bg-zinc-800/50 py-3 px-4 text-sm text-white placeholder-zinc-600 outline-none transition-all focus:border-violet-500/70 focus:ring-2 focus:ring-violet-500/20"
                  rows={4}
                />
              </div>
